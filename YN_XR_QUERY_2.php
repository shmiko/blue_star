...
<?php
	...
	$sql = "SELECT  XR_USER_DESC, ".
	 ...
	 " FROM  PWIN175.YN y INNER JOIN PWIN175.XR x  ON substr(y.YN_DESC,0, INSTR(y.YN_DESC,':') - 1) = x.XR_CODE WHERE   y.YN_TYPE = 'EMAILLIST' AND (XR_CODE = :EIDBV OR INSTR(y.YN_DESC,':') + 1, (INSTR(y.YN_DESC, '#') -1) - (INSTR(y.YN_DESC,':') + 1) + 1 ) = :EIDBV2)";
